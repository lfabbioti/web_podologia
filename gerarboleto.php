  ...
  <body>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.2.1/js/bootstrap.min.js" integrity="sha384-B0UglyR+jN6CkvvICOB2joaf5I4l3gm9GU6Hc1og6Ls7i6U/mkkaduKaBhlAXv9k" crossorigin="anonymous"></script>
    	<div id="total">
			...
			<section>
				<div class="botao">				 
					 <button onclick="window.location.href='boletobradesco.php';">Gerar Boleto Bradesco</button>
				</div>
			<section>
				<div class="botao">
					<button onclick="window.location.href='boletoitau.php';">Gerar Boleto Itaú</button>
			</section>
				</div>
				<div class="botao">
					 <button onclick="window.location.href='boletocaixa.php';">Gerar Boleto Caixa</button>
				</div>
			</section>
